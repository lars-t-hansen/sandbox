...
# This is just an experiment to play around with AWS and Python, it doesn't amount to anything.

import math
import boto3
from mqtt_stuff import *
...
#
#    event:   {"function": function, "arg": something}
#
# The output from the present program is posted by MQTT:
#
#    topic:   math/function/answer
#    payload: {"function": function, "input": arg, "output": result}
#
# Supported functions are "fib", "fact", and "sin"
...
def lambda_handler(event, context):
    ...
    publish(f"math/{function}/answer",
            {"function": function,
             "input":    arg,
             "output":   result,
             "found":    found})
